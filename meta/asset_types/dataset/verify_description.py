...
SECTION_CONTENT_ANNOTATION: str = "Content & Annotation"
SECTION_STATISTICS: str = "Statistics"
...
DA_E002: DiagnosticCode = DiagnosticCode(
    prefix=_PREFIX,
    severity=Severity.ERROR,
    number=2,
)
DA_E007: DiagnosticCode = DiagnosticCode(
    prefix=_PREFIX,
    severity=Severity.ERROR,
    number=7,
)
DA_E009: DiagnosticCode = DiagnosticCode(
    prefix=_PREFIX,
    severity=Severity.ERROR,
    number=9,
)
DA_E012: DiagnosticCode = DiagnosticCode(
    prefix=_PREFIX,
    severity=Severity.ERROR,
    number=12,
)
...
DA_W001: DiagnosticCode = DiagnosticCode(
    prefix=_PREFIX,
    severity=Severity.WARNING,
    number=1,
)
DA_W003: DiagnosticCode = DiagnosticCode(
    prefix=_PREFIX,
    severity=Severity.WARNING,
    number=3,
)
DA_W004: DiagnosticCode = DiagnosticCode(
    prefix=_PREFIX,
    severity=Severity.WARNING,
    number=4,
)
DA_W013: DiagnosticCode = DiagnosticCode(
    prefix=_PREFIX,
    severity=Severity.WARNING,
    number=13,
)
...
def _check_dataset_id_match(
    *,
    ...
    fm_id: object = frontmatter.get(DATASET_ID_FIELD)
    if fm_id is None:
        return []
    if str(fm_id) != dataset_id:
        return [
            Diagnostic(
                code=DA_E007,
                message=(
                    f"dataset_id '{fm_id}' in description document does not match "
                    f"folder name '{dataset_id}'"
                ),
                file_path=file_path,
            ),
        ]
...
def verify_dataset_description(
    *,
    dataset_id: str,
